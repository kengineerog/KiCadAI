...
class _BoardFlipDirection:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType

class _BoardFlipDirectionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_BoardFlipDirection.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    BFD_UNKNOWN: _BoardFlipDirection.ValueType
    BFD_LEFT_RIGHT: _BoardFlipDirection.ValueType
    'Flip left to right (around the Y axis)'
    BFD_TOP_BOTTOM: _BoardFlipDirection.ValueType
    'Flip top to bottom (around the X axis)'

class BoardFlipDirection(_BoardFlipDirection, metaclass=_BoardFlipDirectionEnumTypeWrapper):
    ...
BFD_UNKNOWN: BoardFlipDirection.ValueType
BFD_LEFT_RIGHT: BoardFlipDirection.ValueType
'Flip left to right (around the Y axis)'
BFD_TOP_BOTTOM: BoardFlipDirection.ValueType
'Flip top to bottom (around the X axis)'
global___BoardFlipDirection = BoardFlipDirection
...
@typing.final
class GetBoardLayerByName(google.protobuf.message.Message):
    """Since: 10.0.6
    ...
    def __init__(self, *, board: common.types.base_types_pb2.DocumentSpecifier | None=..., name: builtins.str=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['board', b'board']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['board', b'board', 'name', b'name']) -> None:
        ...
global___GetBoardLayerByName = GetBoardLayerByName
...
class FlipItems(google.protobuf.message.Message):
    ...
    def __init__(self, *, header: common.types.base_types_pb2.ItemHeader | None=..., items: collections.abc.Iterable[common.types.base_types_pb2.KIID] | None=..., direction: global___BoardFlipDirection.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['header', b'header']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['direction', b'direction', 'header', b'header', 'items', b'items']) -> None:
        ...
global___FlipItems = FlipItems

@typing.final
class ItemFlipResult(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    STATUS_FIELD_NUMBER: builtins.int
    ITEM_FIELD_NUMBER: builtins.int

    @property
    def status(self) -> common.commands.editor_commands_pb2.ItemStatus:
        ...
    ...
    def __init__(self, *, status: common.commands.editor_commands_pb2.ItemStatus | None=..., item: google.protobuf.any_pb2.Any | None=...) -> None:
        ...
    ...
    def ClearField(self, field_name: typing.Literal['item', b'item', 'status', b'status']) -> None:
        ...
global___ItemFlipResult = ItemFlipResult

@typing.final
class FlipItemsResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    HEADER_FIELD_NUMBER: builtins.int
    STATUS_FIELD_NUMBER: builtins.int
    FLIPPED_ITEMS_FIELD_NUMBER: builtins.int
    ...
    @property
    def flipped_items(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ItemFlipResult]:
        ...

    def __init__(self, *, header: common.types.base_types_pb2.ItemHeader | None=..., status: common.types.base_types_pb2.ItemRequestStatus.ValueType=..., flipped_items: collections.abc.Iterable[global___ItemFlipResult] | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['header', b'header']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['flipped_items', b'flipped_items', 'header', b'header', 'status', b'status']) -> None:
        ...
global___FlipItemsResponse = FlipItemsResponse
